    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('administrador', 'Administrador'), ('supervisor', 'Supervisor'), ('tecnico', 'Técnico'), ('almacen', 'Almacén'), ('cliente', 'Cliente')], default='cliente', max_length=20, verbose_name='rol')),
